# Generated by Django 3.2.18 on 2023-06-12 02:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_marca', models.ImageField(blank=True, null=True, upload_to='marca/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_prov', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.tipo_proveedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat_prod', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='apps.categorias')),
                ('color_prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.color')),
                ('marca_prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.marca')),
                ('present_prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.presentacion')),
                ('prov_prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.proveedores')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='color_cat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.color'),
        ),
    ]
